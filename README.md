...
**Homepage design:** as of **v3.0.0** the homepage is on the light **"Claude-bone"** palette (bone `#F5F4EF`); inner pages + the blog remain on the legacy dark theme pending their v3.0.x bone conversion.
